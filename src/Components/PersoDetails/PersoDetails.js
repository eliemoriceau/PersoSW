...
export default class PersoDetails extends Component {
    render() {
        ...
        return (
            <Col className={'w-25 border p-3 d-flex flex-column'}>
                ...
                <Row>
                    <Col>
                        ...
                        <p>{new Date(Date.parse(personage.created)).toLocaleString("fr-FR", {day: '2-digit', month: 'numeric', year: 'numeric'})}</p>
                    </Col>
                    <Col>
                        <strong>Edited:</strong>
                        <p>{new Date(Date.parse(personage.edited)).toLocaleString("fr-FR", {day: '2-digit', month: 'numeric', year: 'numeric'})}</p>
                    </Col>
                </Row>
            </Col>
        )
